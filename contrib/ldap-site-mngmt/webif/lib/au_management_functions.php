...
function new_childau($childDN,$childou,$childcn,$childdesc,$mainadmin,$childdomain){
	...
	if ($childdomain) {
		$entryAU ["objectclass"][2] = "domainRelatedObject";
		$entryAU ["associateddomain"] = $childdomain;
	}
	$entryAU ["ou"] = $childou;
	$entryAU ["dhcpmtime"] = 0;
